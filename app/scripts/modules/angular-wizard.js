...
angular.module("wizard.html", []).run(["$templateCache", function($templateCache) {
    $templateCache.put("wizard.html",
           ...
           // "      <div ng-repeat=\"step in steps\" ng-class=\"{'active':step.title == selectedStep.title, default: !step.completed && !step.selected, 'current': step.selected && !step.completed, 'done': step.completed && !step.selected, 'editing': step.selected && step.completed}\">\n" +
            "        <a ng-repeat=\"step in steps\" class = \"helper-set-blockclr\" ng-class=\"{'active':step.title == selectedStep.title, default: " +
                ...
                "<span class=\"fa fa-circle fa-stack-1x fa-orgclr\"></span>" +
                "<span class=\"fa fa-circle fa-stack-1x fa-greyclr\" ng-show=\"step.selected\"></span>" +
                "<span class=\"fa fa-circle fa-greenclr fa-stack-1x\" ng-show=\"step.completed\"></span>" +
                "</span>"+
