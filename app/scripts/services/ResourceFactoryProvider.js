        ...
        ResourceFactoryProvider: function () {
            ...
            this.$get = ['$resource', '$rootScope', function (resource, $rootScope) {
                ...
                return {
                    ...
                    officesResource: defineResource(apiVer + "/offices/officesView", {sqlSearch: '@sqlSearch'}, {
                        get: {method: 'GET', params: {}},
                    ...
                    userListResource: defineResource(apiVer + "/users/:userId", {userId: '@userId', sqlSearch: '@sqlSearch'}, {
                        getAllUsers: {method: 'GET', params: {} },
                        update: { method: 'PUT' }
                    }),
                   ...
                   provisioningcriteria: defineResource(apiVer + "/provisioningcriteria/:criteriaId",{criteriaId:'@criteriaId'},{
                    ...
                    planResource: defineResource(apiVer + "/plans/:planId", {planId:'@planId', sqlSearch: '@sqlSearch'}, {
                        get: {method: 'GET', params: {}},
                        update: { method: 'PUT' }
                    }),
                 ...
                 mediaLocationAttributesResource: defineResource(apiVer + "/assets/locationAttributes/:mediaId", {mediaId:'@mediaId'}, {}),
                  ...
                  viewMrnResource: defineResource(apiVer + "/mrn/view/", {sqlSearch: '@sqlSearch'},{
                           getAlldetails: {method: 'GET', params: {}},
                           get: {method: 'GET', params: {}}
                  }),
                ...
                usercatalogeResource:defineResource(apiVer + "/usercataloge/:usercatalogeId", {usercatalogeId: '@usercatalogeId'}, {
                 ...
                 voucherpinResource: defineResource(apiVer + "/vouchers/:voucherId", {voucherId:'@voucherId', sqlSearch: '@sqlSearch'}, {
                     getAllVouchers: {method: 'GET', params: {}},
                        update: {method: 'PUT', params: {}}
                 }),
              ...
              parentChildResource : defineResource(apiVer + "/parentclient/child/:clientId", {clientId:'@clientId'}, {
               ...
               provisioningrequestfailure: defineResource(apiVer + "/provisioning/provisioningfailure/:clientId", {clientId:'@clientId'}, {
            ...
            renewalListResource: defineResource(apiVer + "/lco/renewallist/:officeId", {officeId:'@officeId'}, {
            	get: {method: 'GET', params: {}}
            }),
            getServiceDetailsResource: defineResource(apiVer + "/servicemasters/serviceParamDetails/:serviceCode", {serviceCode:"@serviceCode"}, {
                get: {method: 'GET', params: {}}
            }),
            getBulkReportsByReportName: defineResource(apiVer + "/bulkreport/:reportName", {reportName:"@reportName"}, {
                get: {method: 'GET', params: {},isArray: true}
            }),
            getReportJobName: defineResource(apiVer + "/jobs/jobname/:jobName", {jobName:"@jobName"}, {
                get: {method: 'GET', params: {}}
            }),
            downloadBulkReport: defineResource(apiVer + "/bulkreport/download", {filePath: "@filePath"}, {
                get: {method: 'GET', params: {}},
                update: { method: 'PUT' }
            }),
            createJobsResource: defineResource(apiVer + "/jobs/create", {}, {
            	get: {method: 'GET', params: {}}
            }),
            editMrnResource: defineResource(apiVer + "/itemsales/edit/:itemsaleId", {itemsaleId: '@itemsaleId'}, {
                update: {method: 'POST' ,params: {}, isArray: false },
                get: {method: 'GET', params: {}}
            }),
            refreshDashboardResource: defineResource(apiVer + "/clients/refreshdashboard", {}, {
            	get: {method: 'GET', params: {}}
            }),
