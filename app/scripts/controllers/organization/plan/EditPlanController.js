  ...
  mifosX.controllers = _.extend(module, {
    EditPlanController: function(scope, routeParams, resourceFactory,dateFilter, location,$rootScope) {
        ...
        resourceFactory.planResource.get({planId: scope.planId, template: 'true'} , function(data) {
            ...
            scope.date.startDate = dateFilter(new Date(startDate),'dd MMMM yyyy HH:mm:ss');
            if(endDate){
            	 scope.date.endDate = dateFilter(new Date(endDate),'dd MMMM yyyy HH:mm:ss');
            }
            ...
            scope.formData.isAdvance = data.isAdvance =='Y'?true:false;
