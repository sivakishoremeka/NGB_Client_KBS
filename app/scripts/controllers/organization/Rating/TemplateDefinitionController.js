(function(module) {
	mifosX.controllers = _
			.extend(
					module,
					{
						TemplateDefinitionController : function(scope,
								resourceFactory, location, $uibModal, route,
								paginatorService) {
							...
							scope.templateData = {};
							// scope.formData1 = {};
							scope.identifierTypes = [ "EventType",
									"ServiceIdentifier" ];
							...
							scope.addTemplateDefinitionData = function() {
								if (scope.fieldName && scope.fieldType
							...
							scope.submit = function() {
								...
								resourceFactory.templateResource.save(
