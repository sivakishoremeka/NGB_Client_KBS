(function (module) {
    mifosX.controllers = _.extend(module, {
        ActivityLogController: function (scope, localStorageService, resourceFactory,dateFilter,paginatorService,routeParams,$uibModal,webStorage,location) {
			...
			scope.getTransactionHistoryFetchFunction = function(offset, limit, callback) {
				resourceFactory.transactionHistoryResourceResource.getTransactionHistory({resourceId : scope.userId,offset : offset,limit : limit}, callback);
			};
			...
			scope.searchTransactionHistory123 = function(offset, limit, callback) {
				...
				resourceFactory.transactionHistoryResourceResource.getTransactionHistory({resourceId : scope.userId,offset : offset,limit : limit,
			...
			scope.getTransHistory=function(offset, limit, callback){
				resourceFactory.transactionHistoryResourceResource.getTransactionHistory({resourceId : scope.userId,offset : offset,limit : limit, fromDate : scope.fromDate, toDate :scope.toDate}, callback);
    ...
    mifosX.ng.application.controller('ActivityLogController', ['$scope',
                                                               'localStorageService',
                                                               'ResourceFactory',
                                                               'dateFilter',
                                                               'PaginatorService',
                                                               ...
                                                               'webStorage',
                                                               '$location',
                                                              mifosX.controllers.ActivityLogController]).run(function ($log) {
