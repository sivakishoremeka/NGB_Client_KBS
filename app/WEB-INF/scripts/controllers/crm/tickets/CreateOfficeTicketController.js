(function(module) {
  mifosX.controllers = _.extend(module, {
	  CreateOfficeTicketController: function(scope,resourceFactory,http,API_VERSION,$rootScope,dateFilter,location,routeParams,Upload) {
		  scope.priorityTypes = [];
		  scope.formData={};
		  scope.problemsDatas = [];
		  scope.usersDatas=[];
  ...
  mifosX.ng.application.controller('CreateOfficeTicketController', ['$scope','ResourceFactory','$http','API_VERSION','$rootScope','dateFilter','$location','$routeParams','Upload',
