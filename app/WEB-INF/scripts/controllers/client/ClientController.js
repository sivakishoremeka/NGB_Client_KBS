(function(module) {
  mifosX.controllers = _.extend(module, {
    ClientController: function(scope, resourceFactory , paginatorService,location,webStorage,$uibModal,TENANT,$rootScope,http, API_VERSION) {
...
*/	    	  
  ...
  mifosX.ng.application.controller('ClientController', ['$scope', 'ResourceFactory', 'PaginatorService','$location','webStorage','$uibModal','TENANT','$rootScope','$http', 
