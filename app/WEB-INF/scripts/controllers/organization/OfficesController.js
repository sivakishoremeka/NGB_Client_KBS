(function (module) {
    mifosX.controllers = _.extend(module, {
        OfficesController: function (scope, resourceFactory, location, $uibModal,paginatorService,route) {
           ...
           /*scope.routeToPartner = function(id,officeId) {
            ...
            scope.officesFetchFunction = function(offset, limit, callback) {
				  resourceFactory.officesResource.get({offset: offset, limit: limit}, function(data) {
    ...
    mifosX.ng.application.controller('OfficesController', ['$scope', 
                                                           ...
                                                           '$location',
                                                           '$uibModal',
                                                           'PaginatorService','$route', mifosX.controllers.OfficesController]).run(function ($log) {
