	...
	scope.paymentGatewayFun  = function(paymentGatewayName){
	     ...
	     switch(paymentGatewayName){
			...
			case evoPG :
				...
				localStorageService.add("evoData",evoData);

				scope.paymentURL = "#/evointegration";
				break;
				
			case local :
				
				var localData = {screenName:screenName,planId:0,priceId:0,price:scope.planData.price,
					clientData:clientData,planCode:scope.planData.planCode, merchantId: paymentGatewayValues.merchantId};
			...
			case cashfree :
				...
				var cashFreeData = {screenName:screenName,planId:0,priceId:0,price:scope.planData.price,
