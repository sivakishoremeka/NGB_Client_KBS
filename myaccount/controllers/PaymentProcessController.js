	   ...
	   scope.paymentGatewayFun  = function(paymentGatewayName){
	     ...
	     switch(paymentGatewayName){
			...
			case local :
				...
				var localData = {screenName:scope.screenName,planId:scope.planId,priceId:scope.priceId,price:scope.price,
					clientData:clientData,planCode:scope.planData.planCode, merchantId: paymentGatewayValues.merchantId};
			...
			case cashfree :
				...
				var cashFreeData = {screenName:scope.screenName,planId:0,priceId:0,price:scope.planData.price,
