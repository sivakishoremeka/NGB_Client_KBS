EvoIntegrationController = function(scope, RequestSender,location, localStorageService,$timeout,rootScope,dateFilter) {  
		...
		*/ 
		  var evoStorageData = localStorageService.get("evoData");
		  var  clientData 			= evoStorageData.clientData,
    	  ...
    	  scope.evoDataJson = {};
    	  scope.evoDataJson.amount= scope.price;
    	  scope.evoDataJson.clientId = clientId;
    	  scope.evoDataJson.merchantId = scope.merchantId;
    	  scope.evoDataJson.currencyType = '356';
   RequestSender.evoPaymentResource.save(scope.evoDataJson,function(data){
