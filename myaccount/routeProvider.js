selfcareApp.config(function($routeProvider, $locationProvider) {
    ...
    .when('/active/:uniqueReference/:registrationKey', {
    ...
    .when('/signupnewuser',{
    	templateUrl: 'views/signupnewuser.html'
    })
    .when('/localpaymentgateway',{
    	templateUrl: 'views/localpaymentgateway.html'
    })
    .when('/cashfreepaymentgateway',{
    	templateUrl: 'views/cashfreepaymentgateway.html'
    })
    .when('/cashfreesuccess',{
    	templateUrl: 'views/cashfreepaysuccess.html'
    });
